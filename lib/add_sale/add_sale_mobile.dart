...
class AddSaleMobile extends StatefulWidget {
  const AddSaleMobile({Key? key}) : super(key: key);

  @override
  State<AddSaleMobile> createState() => _AddSaleMobileState();
}

class _AddSaleMobileState extends State<AddSaleMobile> {
