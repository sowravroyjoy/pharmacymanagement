...
class StockDetailsMobile extends StatefulWidget {
  const StockDetailsMobile({Key? key}) : super(key: key);

  @override
  State<StockDetailsMobile> createState() => _StockDetailsMobileState();
}

class _StockDetailsMobileState extends State<StockDetailsMobile> {
