...
class StockDetailsDesktop extends StatefulWidget {
  const StockDetailsDesktop({Key? key}) : super(key: key);

  @override
  State<StockDetailsDesktop> createState() => _StockDetailsDesktopState();
}

class _StockDetailsDesktopState extends State<StockDetailsDesktop> {
