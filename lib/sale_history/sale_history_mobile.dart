...
class SaleHistoryMobile extends StatefulWidget {
  const SaleHistoryMobile({Key? key}) : super(key: key);

  @override
  State<SaleHistoryMobile> createState() => _SaleHistoryMobileState();
}

class _SaleHistoryMobileState extends State<SaleHistoryMobile> {
